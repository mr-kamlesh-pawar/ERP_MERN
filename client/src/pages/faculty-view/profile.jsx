        ...
        <CardContent>
          <Tabs defaultValue="account" className="space-y-6">
            <TabsList className="gap-4 justify-start grid lg:grid-cols-5 md:grid-flow-col-4 grid-cols-2 lg:mb-2 mb-32">
              <TabsTrigger value="account" className="flex items-center space-x-2 p-2 rounded-lg text-gray-100 hover:bg-blue-100 hover:text-blue-600 focus:ring-2 focus:ring-blue-500 whitespace-nowrap">
              ...
              <TabsTrigger value="work" className="flex items-center space-x-2 p-2 rounded-lg text-gray-100 hover:bg-blue-100 hover:text-blue-600 focus:ring-2 focus:ring-blue-500 whitespace-nowrap">
                <Calendar className="w-5 h-5" />
                <span>Work Info</span>
              </TabsTrigger>
              <TabsTrigger value="address" className="flex items-center space-x-2 p-2 rounded-lg text-gray-100 hover:bg-blue-100 hover:text-blue-600 focus:ring-2 focus:ring-blue-500 whitespace-nowrap">
