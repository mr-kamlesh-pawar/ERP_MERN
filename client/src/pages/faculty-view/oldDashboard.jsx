...
useEffect(() => {
  const fetchCounts = async () => {
    try {
      const response = await fetch("https://rmd-erp-server.vercel.app/api/faculty/dashboard/counts");
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold text-center mb-6">Dashboard Data</h1>
